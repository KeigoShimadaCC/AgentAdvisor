/* Generated from assumption_batch.schema.json. Do not edit manually. */

export type ExtractionNotes = string;
export type NoAssumptionsFound = boolean;
...
export type Records = AssumptionRecord[];
export type SchemaVersion3 = number;
export type SourceScope = string;
...
export interface AssumptionBatch {
  ...
  no_assumptions_found?: NoAssumptionsFound;
  records?: Records;
