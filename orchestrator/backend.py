...
def _extract_usage(usage_obj: Any) -> TokenUsage | None:
    ...
    def _as_non_negative_int(key: str) -> int | None:
    ...
    usage = TokenUsage(
        input_tokens=_as_non_negative_int("inputTokens"),
        output_tokens=_as_non_negative_int("outputTokens"),
        cache_read_tokens=_as_non_negative_int("cacheReadTokens"),
        cache_write_tokens=_as_non_negative_int("cacheWriteTokens"),
    )
    ...
    def run(self, invocation: RoleInvocation) -> RoleResult:
        ...
        try:
            ...
            return RoleResult(
                ...
                cli_version=_detect_cli_version(self._binary_path),
            )
        ...
        usage = _extract_usage(envelope.get("usage"))
