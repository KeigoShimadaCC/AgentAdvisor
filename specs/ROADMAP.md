...
- (2026-08-02) Researcher and analyst produce most of the token spend at the worst success rates (23% and 33% in scenario 01, 30 validation failures across the case, ~4M tokens). Their output contracts deserve the same rewrite track B got.
